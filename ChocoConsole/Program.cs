...
class Program
{
    static void Main(string[] args)
    {
        ...
        var adminService = new AdminService(logger, new Interaction.FileService(), new Interaction.FileService(), new Interaction.FileService(), new Interaction.FileService());
